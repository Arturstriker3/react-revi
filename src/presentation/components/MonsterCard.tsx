      ...
      <div className="relative h-full flex flex-col p-4 z-10">
        ...
        <div className="flex justify-center mb-3">
          {Array.from({ length: Math.min(level, 8) }).map((_, i) => (
            <GiCrystalEye key={i} className="w-4 h-4 text-yellow-500 mx-0.5" />
          ))}
        </div>

        {/* Monster Image */}
        <div className="flex-1 relative mb-4 bg-gradient-to-br from-slate-700 to-slate-900 rounded-lg border-2 border-amber-300 overflow-hidden">
          <img
        ...
        {/* Stats */}
        <div className="bg-gradient-to-r from-amber-200 to-yellow-200 rounded-lg p-3 border border-amber-400">
